...
const AdminAcceptanceCriteria: React.FC = () => {
    ...
    const DocumentList: React.FC = () => {
        ...
        const filteredDocs = React.useMemo(() =>
            docs.filter(d => d.category === DocumentCategory.AcceptanceCriteria && (selectedLine && d.lineId === selectedLine.id)),
            [docs, selectedLine]);
    ...
    return (
        <div className="h-full flex flex-col">
            <div className="flex justify-between items-center mb-6">
                <h2 className="text-3xl font-bold text-cyan-600 dark:text-cyan-400">{t('acceptanceCriteria.title')} (P2)</h2>
            ...
            <Modal isOpen={isDeleteModalOpen} onClose={cancelDelete} title={t('admin.confirmDelete')}>
                <div className="space-y-6">
                    <p className="text-xl text-gray-800 dark:text-gray-300">{t('admin.deleteAcceptanceCriteriaConfirm')}</p>
                    <div className="flex justify-end space-x-4">
...
export default AdminAcceptanceCriteria;
