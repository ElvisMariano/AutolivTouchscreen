...
import { WorkStation, getStations as getStationsByLine } from '@/services/api/stations';
import { getDocuments, createDocument, updateDocument, deleteDocument } from '@/services/api/documents';
// StationInstruction type replacement? Using generic Document/LineDocument?
import { LineDocument as StationInstruction } from '@/services/api/documents';
